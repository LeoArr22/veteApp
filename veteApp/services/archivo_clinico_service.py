...
# ---------------------------------------------------------
def listar_archivos_consulta_service(db: Session, consulta_id: int, solo_activos: bool = True) -> list[ArchivoClinicoReadDTO]:
    """
    Recupera los documentos adjuntos a una consulta.
    """
    if not obtener_consulta_por_id(db, consulta_id) and solo_activos:
